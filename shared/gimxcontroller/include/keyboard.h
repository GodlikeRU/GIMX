...
typedef enum
{
  ...
  kb_BN = abs_axis_25,
  kb_BM = abs_axis_26,
  kb_BBackspace = abs_axis_27,
  kb_BEnter = abs_axis_28,
  kb_BSpace = abs_axis_29,
  kb_BLAlt = abs_axis_40,
  kb_BRAlt = abs_axis_41,
  kb_BLShift = abs_axis_42,
  kb_BRShift = abs_axis_43,
  kb_BLCtrl = abs_axis_44,
  kb_BRCtrl = abs_axis_45,
  kb_BCapsLock = abs_axis_46,
  kb_BTab = abs_axis_47,
  kb_BTilde = abs_axis_48,
  kb_BEsc = abs_axis_49,
  kb_BF1 = abs_axis_50,
  kb_BF2 = abs_axis_51,
  kb_BF3 = abs_axis_52,
  ...
  kb_BF11 = abs_axis_60,
  kb_BF12 = abs_axis_61,
  kb_BPrintScreen = abs_axis_62,
  kb_BPauseBreak = abs_axis_63,
  kb_BDelete = abs_axis_64,
  kb_BPlus = abs_axis_65,
  kb_BMinus = abs_axis_66,
  kb_BOpeningBracket = abs_axis_67,
  kb_BClosingBracket = abs_axis_68,
  kb_BBackslash = abs_axis_69,
  kb_BSemicolon = abs_axis_70,
  kb_BApostrophe = abs_axis_71,
  kb_BComma = abs_axis_72,
  kb_BDot = abs_axis_73,
  kb_BSlash = abs_axis_74,
  kb_BLeftArrow = abs_axis_75,
  kb_BRightArrow = abs_axis_76,
  kb_BUpArrow = abs_axis_77,
  kb_BDownArrow = abs_axis_78,
} e_keyboard_axis_index;
